...
class Cidade {
    ...
    public function __toString(){
        ...
        return "A cidade $this->nome, localizada no estado do " . $this->estado->getNome() . "-" . $this->estado->getSigla() . ", possui: $this->qtdHabitantes habitantes e uma altitude de $this->altitude metros \n";
